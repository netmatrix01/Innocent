<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DetailedEmbellishments.ascx.cs" Inherits="NopSolutions.NopCommerce.Web.Modules.DetailedEmbellishments" %>
