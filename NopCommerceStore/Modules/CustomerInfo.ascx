        ...
        <table class="table-container">
            <tbody>
                <asp:PlaceHolder runat="server" ID="phGender">
                    <tr class="row">
                        <td class="item-name">
                            <%=GetLocaleResourceString("Account.Title")%>:
                        </td>
                        <td class="item-value">
                            <asp:TextBox ID="txtTitle" runat="server" MaxLength="40"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTitle"
                                ErrorMessage="<% $NopResources:Account.Account.TitleIsRequired %>" ToolTip="<% $NopResources:Account.TitleIsRequired %>"
                ...
                <tbody>
                    ...
                    <asp:PlaceHolder runat="server" ID="phVatNumber">
                        <tr class="row">
                            ...
                            <td class="item-value">
                                <asp:TextBox ID="txtVatNumber" runat="server" />&nbsp;&nbsp;&nbsp;<asp:Label ID="lblVatNumberStatus"
                                    runat="server" />
                            </td>
                        </tr>
                    </asp:PlaceHolder>
