...
<table class="adminContent">
    ...
    <tr>
         <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="ToolTipLabel1" Text="<% $NopResources:Admin.CustomerInfo.Title %>"
                ToolTip="<% $NopResources:Admin.CustomerInfo.Title.Tooltip %>" ToolTipImage="~/Administration/Common/ico-help.gif" />
        </td>
        <td class="adminData">
            <asp:TextBox runat="server" ID="txtTitle" CssClass="adminInput" />
        </td>
    </tr>
