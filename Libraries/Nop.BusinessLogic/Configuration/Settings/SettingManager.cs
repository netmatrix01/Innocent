...
namespace NopSolutions.NopCommerce.BusinessLogic.Configuration.Settings
{
    ...
    public class SettingManager
    {
        ...
        public static Setting GetSettingById(int settingId)
        {
            ...
            IQueryable<Setting> query = from s in context.Settings
                                        where s.SettingId == settingId
                                        select s;
            Setting setting = query.SingleOrDefault();
            return setting;
        }
        ...
        public static Dictionary<string, Setting> GetAllSettings()
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IOrderedQueryable<Setting> query = from s in context.Settings
                                               orderby s.Name
                                               select s;
            Dictionary<string, Setting> settings = query.ToDictionary(s => s.Name.ToLowerInvariant());
        ...
        public static Setting AddSetting(string name, string value, string description)
        {
            ...
            Setting setting = context.Settings.CreateObject();
            setting.Name = name;
            setting.Value = value;
        ...
        public static Setting GetSettingByName(string name)
        {
            ...
            Dictionary<string, Setting> settings = GetAllSettings();
        ...
        public static string StoreName
        {
            ...
            set { SetParam("Common.StoreName", value); }
        }
        ...
        public static string StoreUrl
        {
            ...
            set { SetParam("Common.StoreURL", value); }
        }
