...
namespace NopSolutions.NopCommerce.BusinessLogic.Content.NewsManagement
{
    ...
    public class NewsManager
    {
        ...
        public static News GetNewsById(int newsId)
        {
            ...
            IQueryable<News> query = from n in context.News
                                     where n.NewsId == newsId
                                     select n;
            News news = query.SingleOrDefault();
                                            ...
                                            int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            List<News> news = context.Sp_NewsLoadAll(languageId, showHidden,
                                      ...
                                      string fullText, bool published, bool allowComments, DateTime createdOn)
        {
            ...
            News news = context.News.CreateObject();
        ...
        public static NewsComment GetNewsCommentById(int newsCommentId)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IQueryable<NewsComment> query = from nc in context.NewsComments
                                            where nc.NewsCommentId == newsCommentId
                                            select nc;
            NewsComment newsComment = query.SingleOrDefault();
            return newsComment;
        }
        ...
        public static List<NewsComment> GetNewsCommentsByNewsId(int newsId)
        {
            ...
            IQueryable<NewsComment> query = from nc in context.NewsComments
                                            ...
                                            select nc;
            List<NewsComment> newsComments = query.ToList();
            return newsComments;
        }
        ...
        {
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IOrderedQueryable<NewsComment> query = from nc in context.NewsComments
                                                   orderby nc.CreatedOn
                                                   select nc;
            List<NewsComment> newsComments = query.ToList();
            return newsComments;
                                                    ...
                                                    string title, string comment, DateTime createdOn)
        {
            return InsertNewsComment(newsId, customerId, title, comment,
                                     createdOn, NotifyAboutNewNewsComments);
        }
                                                    ...
                                                    string title, string comment, DateTime createdOn, bool notify)
        {
            ...
            NewsComment newsComment = context.NewsComments.CreateObject();
            ...
            if (notify)
            {
                MessageManager.SendNewsCommentNotificationMessage(newsComment,
        ...
        {
            get { return SettingManager.GetSettingValueBoolean("Cache.NewsManager.CacheEnabled"); }
        }
        ...
        public static bool NewsEnabled
        {
            ...
            set { SettingManager.SetParam("News.NewsEnabled", value.ToString()); }
        }
        ...
        {
            get { return SettingManager.GetSettingValueBoolean("News.AllowNotRegisteredUsersToLeaveComments"); }
            set { SettingManager.SetParam("News.AllowNotRegisteredUsersToLeaveComments", value.ToString()); }
        }
        ...
        {
            get { return SettingManager.GetSettingValueBoolean("News.NotifyAboutNewNewsComments"); }
            set { SettingManager.SetParam("News.NotifyAboutNewNewsComments", value.ToString()); }
        }
        ...
        public static bool ShowNewsOnMainPage
        {
            ...
            set { SettingManager.SetParam("Display.ShowNewsOnMainPage", value.ToString()); }
        }
        ...
        public static int MainPageNewsCount
        {
            ...
            set { SettingManager.SetParam("Display.MainPageNewsCount", value.ToString()); }
        }
        ...
        {
            get { return SettingManager.GetSettingValueInteger("Display.NewsArchivePageSize", 10); }
            set { SettingManager.SetParam("Display.NewsArchivePageSize", value.ToString()); }
        }
