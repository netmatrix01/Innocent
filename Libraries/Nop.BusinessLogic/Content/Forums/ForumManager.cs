...
namespace NopSolutions.NopCommerce.BusinessLogic.Content.Forums
{
    ...
    public class ForumManager
    {
        ...
        {
            ForumGroup forumGroup = GetForumGroupById(forumGroupId);
            if (forumGroup == null)
                return;
        ...
        public static ForumGroup GetForumGroupById(int forumGroupId)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IQueryable<ForumGroup> query = from fg in context.ForumGroups
                                           where fg.ForumGroupId == forumGroupId
                                           select fg;
            ForumGroup forumGroup = query.SingleOrDefault();
        ...
        public static List<ForumGroup> GetAllForumGroups()
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IOrderedQueryable<ForumGroup> query = from fg in context.ForumGroups
                                                  orderby fg.DisplayOrder
                                                  select fg;
            List<ForumGroup> forumGroups = query.ToList();
                                                  ...
                                                  int displayOrder, DateTime createdOn, DateTime updatedOn)
        {
            ...
            ForumGroup forumGroup = context.ForumGroups.CreateObject();
        ...
        public static Forum GetForumById(int forumId)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IQueryable<Forum> query = from f in context.Forums
                                      where f.ForumId == forumId
                                      select f;
            Forum forum = query.SingleOrDefault();
        ...
        public static List<Forum> GetAllForumsByGroupId(int forumGroupId)
        {
            ...
            IQueryable<Forum> query = from f in context.Forums
                                      ...
                                      select f;
            List<Forum> forums = query.ToList();
                                        ...
                                        DateTime createdOn, DateTime updatedOn)
        {
            ...
            Forum forum = context.Forums.CreateObject();
        ...
        public static ForumTopic GetTopicById(int forumTopicId, bool increaseViews)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IQueryable<ForumTopic> query = from ft in context.ForumTopics
                                           where ft.ForumTopicId == forumTopicId
                                           select ft;
            ForumTopic forumTopic = query.SingleOrDefault();
            if (forumTopic == null)
                return null;
                                                    ...
                                                    int pageIndex, out int totalRecords)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            List<ForumTopic> forumTopics = context.Sp_Forums_TopicLoadAll(forumId,
        ...
        {
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            List<ForumTopic> forumTopics = context.Sp_Forums_TopicLoadActive(forumId, topicCount);
            return forumTopics;
        }
                                             ...
                                             DateTime createdOn, DateTime updatedOn, bool sendNotifications)
        {
            ...
            if (TopicSubjectMaxLength > 0)
            {
                if (subject.Length > TopicSubjectMaxLength)
                    subject = subject.Substring(0, TopicSubjectMaxLength);
            }
            ...
            ForumTopic forumTopic = context.ForumTopics.CreateObject();
            ...
            if (sendNotifications)
            {
                ...
                List<ForumSubscription> subscriptions = GetAllSubscriptions(0, forum.ForumId, 0, int.MaxValue, 0);
        ...
        public static ForumTopic MoveTopic(int forumTopicId, int newForumId)
        {
            ...
            if (IsUserAllowedToMoveTopic(NopContext.Current.User, forumTopic))
            {
        ...
        {
            ForumPost forumPost = GetPostById(forumPostId);
            if (forumPost == null)
                return;
        ...
        public static ForumPost GetPostById(int forumPostId)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IQueryable<ForumPost> query = from fp in context.ForumPosts
                                          where fp.ForumPostId == forumPostId
                                          select fp;
            ForumPost forumPost = query.SingleOrDefault();
        ...
        public static List<ForumPost> GetAllPosts(int forumTopicId,
                                                  int userId, string keywords, int pageSize, int pageIndex,
        ...
        public static List<ForumPost> GetAllPosts(int forumTopicId, int userId,
                                                  string keywords, bool ascSort, int pageSize, int pageIndex,
                                                  out int totalRecords)
        {
            if (pageSize <= 0)
                pageSize = 10;
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            List<ForumPost> forumPosts = context.Sp_Forums_PostLoadAll(forumTopicId,
                                                                       userId, keywords, ascSort, pageSize, pageIndex,
                                                                       out totalRecords);
                                           ...
                                           bool sendNotifications)
        {
            ...
            if (PostMaxLength > 0)
            {
                if (text.Length > PostMaxLength)
                    text = text.Substring(0, PostMaxLength);
            }
            ...
            ForumPost forumPost = context.ForumPosts.CreateObject();
            ...
            if (sendNotifications)
            {
                ...
                Forum forum = forumTopic.Forum;
                List<ForumSubscription> subscriptions = GetAllSubscriptions(0, 0,
        ...
        {
            PrivateMessage privateMessage = GetPrivateMessageById(forumPrivateMessageId);
        ...
        public static PrivateMessage GetPrivateMessageById(int forumPrivateMessageId)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IQueryable<PrivateMessage> query = from pm in context.PrivateMessages
                                               where pm.PrivateMessageId == forumPrivateMessageId
                                               select pm;
            PrivateMessage privateMessage = query.SingleOrDefault();
        ...
        public static List<PrivateMessage> GetAllPrivateMessages(int fromUserId,
                                                                 int toUserId, bool? isRead, bool? isDeletedByAuthor,
                                                                 bool? isDeletedByRecipient,
                                                                 string keywords, int pageSize, int pageIndex,
                                                                 out int totalRecords)
        {
            if (pageSize <= 0)
                pageSize = 10;
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            List<PrivateMessage> privateMessages = context.Sp_Forums_PrivateMessageLoadAll(fromUserId,
                                                                                           toUserId, isRead,
                                                                                           isDeletedByAuthor,
                                                                                           isDeletedByRecipient,
                                                                                           keywords, pageSize, pageIndex,
                                                                                           out totalRecords);
        ...
        public static PrivateMessage InsertPrivateMessage(int fromUserId,
                                                          ...
                                                          bool isDeletedByAuthor, bool isDeletedByRecipient,
                                                          DateTime createdOn)
        {
            if (subject == null)
                subject = string.Empty;
            ...
            if (PMSubjectMaxLength > 0)
            {
                if (subject.Length > PMSubjectMaxLength)
                    subject = subject.Substring(0, PMSubjectMaxLength);
            }
            ...
            if (PMTextMaxLength > 0)
            {
                if (text.Length > PMTextMaxLength)
                    text = text.Substring(0, PMTextMaxLength);
            }
            ...
            PrivateMessage privateMessage = context.PrivateMessages.CreateObject();
        ...
        public static PrivateMessage UpdatePrivateMessage(int privateMessageId,
                                                          int fromUserId, int toUserId, string subject, string text,
                                                          bool isRead,
                                                          bool isDeletedByAuthor, bool isDeletedByRecipient,
                                                          DateTime createdOn)
        {
            ...
            {
                PrivateMessage privateMessage = GetPrivateMessageById(privateMessageId);
                if (privateMessage == null)
                    return null;
        ...
        {
            ForumSubscription forumSubscription = GetSubscriptionById(forumSubscriptionId);
        ...
        public static ForumSubscription GetSubscriptionById(int forumSubscriptionId)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IQueryable<ForumSubscription> query = from fs in context.ForumSubscriptions
                                                  where fs.ForumSubscriptionId == forumSubscriptionId
                                                  select fs;
            ForumSubscription forumSubscription = query.SingleOrDefault();
                                                                  ...
                                                                  out int totalRecords)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            List<ForumSubscription> forumSubscriptions = context.Sp_Forums_SubscriptionLoadAll(userId,
                                                                                               forumId, topicId,
                                                                                               pageSize, pageIndex,
                                                                                               out totalRecords);
                                                           ...
                                                           int forumId, int topicId, DateTime createdOn)
        {
            ...
            ForumSubscription forumSubscription = context.ForumSubscriptions.CreateObject();
        ...
        public static ForumSubscription UpdateSubscription(int subscriptionId,
                                                           Guid subscriptionGuid, int userId, int forumId, int topicId,
                                                           DateTime createdOn)
        {
            ForumSubscription forumSubscription = GetSubscriptionById(subscriptionId);
            if (forumSubscription == null)
                return null;
        ...
        public static bool IsUserAllowedToDeleteTopic(Customer customer, ForumTopic topic)
        {
            ...
            if (AllowCustomersToDeletePosts)
            {
                bool ownTopic = customer.CustomerId == topic.UserId;
                return ownTopic;
            }
        ...
        public static int CalculateTopicPageIndex(int forumTopicId, int pageSize, int postId)
        {
            int pageIndex = 0;
            int totalRecords = 0;
            List<ForumPost> forumPosts = GetAllPosts(forumTopicId, 0,
        ...
        {
            get { return SettingManager.GetSettingValueBoolean("Cache.ForumManager.CacheEnabled"); }
        }
        ...
        public static bool ForumsEnabled
        {
            ...
            set { SettingManager.SetParam("Forums.ForumsEnabled", value.ToString()); }
        }
        ...
        public static bool AllowCustomersToEditPosts
        {
            get
            {
                bool allowCustomersToEditPosts =
                    SettingManager.GetSettingValueBoolean("Forums.CustomersAllowedToEditPosts");
                return allowCustomersToEditPosts;
            }
            set { SettingManager.SetParam("Forums.CustomersAllowedToEditPosts", value.ToString()); }
        }
        ...
        {
            get { return SettingManager.GetSettingValueBoolean("Forums.CustomersAllowedToManageSubscriptions"); }
            set { SettingManager.SetParam("Forums.CustomersAllowedToManageSubscriptions", value.ToString()); }
        }
        ...
        {
            get { return SettingManager.GetSettingValueBoolean("Forums.GuestsAllowedToCreatePosts"); }
            set { SettingManager.SetParam("Forums.GuestsAllowedToCreatePosts", value.ToString()); }
        }
        ...
        {
            get { return SettingManager.GetSettingValueBoolean("Forums.GuestsAllowedToCreateTopics"); }
            set { SettingManager.SetParam("Forums.GuestsAllowedToCreateTopics", value.ToString()); }
        }
        ...
        public static bool AllowCustomersToDeletePosts
        {
            get
            {
                bool allowCustomersToDeletePosts =
                    SettingManager.GetSettingValueBoolean("Forums.CustomersAllowedToDeletePosts");
                return allowCustomersToDeletePosts;
            }
            set { SettingManager.SetParam("Forums.CustomersAllowedToDeletePosts", value.ToString()); }
        }
        ...
        public static int TopicSubjectMaxLength
        {
            ...
            set { SettingManager.SetParam("Forums.TopicSubjectMaxLength", value.ToString()); }
        }
        ...
        public static int PostMaxLength
        {
            ...
            set { SettingManager.SetParam("Forums.PostMaxLength", value.ToString()); }
        }
        ...
        public static int TopicsPageSize
        {
            ...
            set { SettingManager.SetParam("Forums.TopicsPageSize", value.ToString()); }
        }
        ...
        public static int PostsPageSize
        {
            ...
            set { SettingManager.SetParam("Forums.PostsPageSize", value.ToString()); }
        }
        ...
        public static int SearchResultsPageSize
        {
            ...
            set { SettingManager.SetParam("Forums.SearchResultsPageSize", value.ToString()); }
        }
        ...
        public static int LatestUserPostsPageSize
        {
            ...
            set { SettingManager.SetParam("Forums.LatestUserPostsPageSize", value.ToString()); }
        }
        ...
        public static bool ShowCustomersPostCount
        {
            ...
            set { SettingManager.SetParam("Forums.ShowCustomersPostCount", value.ToString()); }
        }
        ...
        public static EditorTypeEnum ForumEditor
        {
            ...
            set { SettingManager.SetParam("Forums.EditorType", ((int) value).ToString()); }
        }
        ...
        public static bool SignaturesEnabled
        {
            ...
            set { SettingManager.SetParam("Forums.SignatureEnabled", value.ToString()); }
        }
        ...
        public static bool AllowPrivateMessages
        {
            ...
            set { SettingManager.SetParam("Messaging.AllowPM", value.ToString()); }
        }
        ...
        public static int PMSubjectMaxLength
        {
            ...
            set { SettingManager.SetParam("Messaging.PMSubjectMaxLength", value.ToString()); }
        }
        ...
        public static int PMTextMaxLength
        {
            ...
            set { SettingManager.SetParam("Messaging.PMTextMaxLength", value.ToString()); }
        }
