...
namespace NopSolutions.NopCommerce.BusinessLogic.CustomerManagement
{
    ...
    public class CustomerManager
    {
        ...
        public static Address GetAddressById(int addressId)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IQueryable<Address> query = from a in context.Addresses
                                        where a.AddressId == addressId
                                        select a;
            Address address = query.SingleOrDefault();
        ...
        public static List<Address> GetAddressesByCustomerId(int customerId, bool getBillingAddresses)
        {
            ...
            IQueryable<Address> query = from a in context.Addresses
                                        ...
                                        select a;
            List<Address> addresses = query.ToList();
                                            ...
                                            int countryId, DateTime createdOn, DateTime updatedOn)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            Address address = context.Addresses.CreateObject();
        ...
        public static void CreateAnonymousUser()
        {
            ...
            if (guestCustomer != null && status == MembershipCreateStatus.Success)
            {
                ...
                NopContext.Current.Session = UpdateCustomerSession(NopContext.Current.Session.CustomerSessionGuid,
                                                                   guestCustomer.CustomerId, LastAccessed,
                                                                   NopContext.Current.Session.IsExpired);
            }
        }
        ...
        public static List<Customer> GetAllCustomers(DateTime? registrationFrom,
                                                     DateTime? registrationTo, string email, string username,
                                                     bool dontLoadGuestCustomers, int dateOfBirthMonth,
                                                     int dateOfBirthDay,
                                                     int pageSize, int pageIndex, out int totalRecords)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            List<Customer> customers = context.Sp_CustomerLoadAll(registrationFrom,
                                                                  registrationTo, email, username,
                                                                  dontLoadGuestCustomers,
        ...
        public static Customer GetCustomerById(int customerId)
        {
            ...
            IQueryable<Customer> query = from c in context.Customers
                                         ...
                                         select c;
            Customer customer = query.SingleOrDefault();
            return customer;
        }
        ...
        public static Customer GetCustomerByGuid(Guid customerGuid)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IOrderedQueryable<Customer> query = from c in context.Customers
        ...
        public static Customer AddCustomer(Guid customerGuid, string email, string username,
                                           ...
                                           TaxDisplayTypeEnum taxDisplayType, bool isTaxExempt, bool isAdmin,
                                           bool isGuest,
                                           bool isForumModerator, int totalForumPosts, string signature,
                                           string adminComment,
                                           ...
                                           out MembershipCreateStatus status)
        {
            ...
            if (!isGuest)
            {
                ...
                {
                    if (CustomerRegistrationType == CustomerRegistrationTypeEnum.Disabled)
                    {
                ...
                if (!NopContext.Current.IsAdmin)
                {
                    if (CustomerRegistrationType == CustomerRegistrationTypeEnum.EmailValidation ||
                        CustomerRegistrationType == CustomerRegistrationTypeEnum.AdminApproval)
                    {
                        active = false;
                    }
                }
                                                 ...
                                                 int avatarId, DateTime? dateOfBirth)
        {
            ...
            Customer customer = context.Customers.CreateObject();
            ...
            {
                RewardPointsHistory rph = OrderManager.InsertRewardPointsHistory(customer.CustomerId, 0,
                                                                                 OrderManager.
                                                                                     RewardPointsForRegistration,
        ...
        public static bool Login(string email, string password)
        {
            ...
            if (result)
            {
                ...
                if (registeredCustomerSession != null)
                {
                    ...
                    if ((anonCustomerSession != null) &&
                        (anonCustomerSession.CustomerSessionGuid != registeredCustomerSession.CustomerSessionGuid))
                    {
                        if (anonCustomerSession.Customer != null)
                        {
                            customer = ApplyDiscountCouponCode(customer.CustomerId,
                                                               anonCustomerSession.Customer.LastAppliedCouponCode);
                            customer = ApplyGiftCardCouponCode(customer.CustomerId,
                                                               anonCustomerSession.Customer.GiftCardCouponCodes);
                        }
                ...
                NopContext.Current.Session = SaveCustomerSession(NopContext.Current.Session.CustomerSessionGuid,
        ...
        public static List<CustomerBestReportLine> GetBestCustomersReport(DateTime? startTime,
                                                                          DateTime? endTime, OrderStatusEnum? os,
                                                                          PaymentStatusEnum? ps,
                                                                          ShippingStatusEnum? ss, int orderBy)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            List<CustomerBestReportLine> report = context.Sp_CustomerBestReport(startTime, endTime,
                                                                                orderStatusId, paymentStatusId,
                                                                                shippingStatusId, orderBy).ToList();
        ...
        {
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            List<CustomerReportByLanguageLine> report = context.Sp_CustomerReportByLanguage().ToList();
        ...
        public static List<CustomerReportByAttributeKeyLine> GetCustomerReportByAttributeKey(string customerAttributeKey)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            List<CustomerReportByAttributeKeyLine> report =
                context.Sp_CustomerReportByAttributeKey(customerAttributeKey).ToList();
        ...
        {
            CustomerAttribute customerAttribute = GetCustomerAttributeById(customerAttributeId);
        ...
        public static CustomerAttribute GetCustomerAttributeById(int customerAttributeId)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IQueryable<CustomerAttribute> query = from ca in context.CustomerAttributes
                                                  where ca.CustomerAttributeId == customerAttributeId
                                                  select ca;
            CustomerAttribute customerAttribute = query.SingleOrDefault();
        ...
        public static List<CustomerAttribute> GetCustomerAttributesByCustomerId(int customerId)
        {
            ...
            IQueryable<CustomerAttribute> query = from ca in context.CustomerAttributes
                                                  ...
                                                  select ca;
            List<CustomerAttribute> customerAttributes = query.ToList();
                                                                ...
                                                                string key, string value)
        {
            ...
            CustomerAttribute customerAttribute = context.CustomerAttributes.CreateObject();
        ...
        public static CustomerRole GetCustomerRoleById(int customerRoleId)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IQueryable<CustomerRole> query = from cr in context.CustomerRoles
                                             where cr.CustomerRoleId == customerRoleId
                                             select cr;
            CustomerRole customerRole = query.SingleOrDefault();
        ...
        public static List<CustomerRole> GetAllCustomerRoles()
        {
            ...
            IQueryable<CustomerRole> query = from cr in context.CustomerRoles
                                             ...
                                             select cr;
            List<CustomerRole> customerRoles = query.ToList();
                                                      ...
                                                      bool freeShipping, bool taxExempt, bool active, bool deleted)
        {
            ...
            CustomerRole customerRole = context.CustomerRoles.CreateObject();
        ...
        {
            Discount discount = DiscountManager.GetDiscountById(discountId);
            if (discount == null)
                return;
        ...
        public static CustomerSession GetCustomerSessionByGuid(Guid customerSessionGuid)
        {
            ...
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            IOrderedQueryable<CustomerSession> query = from cs in context.CustomerSessions
                                                       where cs.CustomerSessionGuid == customerSessionGuid
                                                       orderby cs.LastAccessed descending
                                                       select cs;
            CustomerSession customerSession = query.FirstOrDefault();
        ...
        {
            CustomerSession customerSession = GetCustomerSessionByGuid(customerSessionGuid);
        ...
        public static List<CustomerSession> GetAllCustomerSessions()
        {
            ...
            IOrderedQueryable<CustomerSession> query = from cs in context.CustomerSessions
                                                       orderby cs.LastAccessed descending
                                                       select cs;
            List<CustomerSession> customerSessions = query.ToList();
        ...
        {
            NopObjectContext context = ObjectContextHelper.CurrentObjectContext;
            CustomerSession customerSession = context.CustomerSessions.CreateObject();
        ...
        {
            get { return SettingManager.GetSettingValueBoolean("Cache.CustomerManager.CacheEnabled"); }
        }
        ...
        public static bool AnonymousCheckoutAllowed
        {
            ...
            set { SettingManager.SetParam("Checkout.AnonymousCheckoutAllowed", value.ToString()); }
        }
        ...
        public static bool UsernamesEnabled
        {
            ...
            set { SettingManager.SetParam("Customer.UsernamesEnabled", value.ToString()); }
        }
        ...
        public static CustomerNameFormatEnum CustomerNameFormatting
        {
            ...
            set { SettingManager.SetParam("Customer.CustomerNameFormatting", ((int) value).ToString()); }
        }
        ...
        public static bool AllowCustomersToUploadAvatars
        {
            get
            {
                bool allowCustomersToUploadAvatars =
                    SettingManager.GetSettingValueBoolean("Customer.CustomersAllowedToUploadAvatars");
                return allowCustomersToUploadAvatars;
            }
            set { SettingManager.SetParam("Customer.CustomersAllowedToUploadAvatars", value.ToString()); }
        }
        ...
        public static bool DefaultAvatarEnabled
        {
            ...
            set { SettingManager.SetParam("Customer.DefaultAvatarEnabled", value.ToString()); }
        }
        ...
        public static bool ShowCustomersLocation
        {
            ...
            set { SettingManager.SetParam("Customer.ShowCustomersLocation", value.ToString()); }
        }
        ...
        public static bool ShowCustomersJoinDate
        {
            ...
            set { SettingManager.SetParam("Customer.ShowCustomersJoinDate", value.ToString()); }
        }
        ...
        public static bool AllowViewingProfiles
        {
            ...
            set { SettingManager.SetParam("Customer.AllowViewingProfiles", value.ToString()); }
        }
        ...
        public static CustomerRegistrationTypeEnum CustomerRegistrationType
        {
            get
            {
                int customerRegistrationType = SettingManager.GetSettingValueInteger("Common.CustomerRegistrationType",
                                                                                     (int)
                                                                                     CustomerRegistrationTypeEnum.
                                                                                         Standard);
                return (CustomerRegistrationTypeEnum) customerRegistrationType;
            }
            set { SettingManager.SetParam("Common.CustomerRegistrationType", ((int) value).ToString()); }
        }
        ...
        public static bool AllowNavigationOnlyRegisteredCustomers
        {
            get
            {
                bool allowOnlyRegisteredCustomers =
                    SettingManager.GetSettingValueBoolean("Common.AllowNavigationOnlyRegisteredCustomers");
                return allowOnlyRegisteredCustomers;
            }
            set { SettingManager.SetParam("Common.AllowNavigationOnlyRegisteredCustomers", value.ToString()); }
        }
        ...
        public static bool ProductReviewsMustBeApproved
        {
            get
            {
                bool productReviewsMustBeApproved =
                    SettingManager.GetSettingValueBoolean("Common.ProductReviewsMustBeApproved");
                return productReviewsMustBeApproved;
            }
            set { SettingManager.SetParam("Common.ProductReviewsMustBeApproved", value.ToString()); }
        }
        ...
        public static bool AllowAnonymousUsersToReviewProduct
        {
            get
            {
                bool allowAnonymousUsersToReviewProduct =
                    SettingManager.GetSettingValueBoolean("Common.AllowAnonymousUsersToReviewProduct");
                return allowAnonymousUsersToReviewProduct;
            }
            set { SettingManager.SetParam("Common.AllowAnonymousUsersToReviewProduct", value.ToString()); }
        }
        ...
        {
            get { return SettingManager.GetSettingValueBoolean("Common.AllowAnonymousUsersToEmailAFriend", false); }
            set { SettingManager.SetParam("Common.AllowAnonymousUsersToEmailAFriend", value.ToString()); }
        }
        ...
        public static bool AllowAnonymousUsersToSetProductRatings
        {
            get
            {
                bool allowAnonymousUsersToSetProductRatings =
                    SettingManager.GetSettingValueBoolean("Common.AllowAnonymousUsersToSetProductRatings");
                return allowAnonymousUsersToSetProductRatings;
            }
            set { SettingManager.SetParam("Common.AllowAnonymousUsersToSetProductRatings", value.ToString()); }
        }
        ...
        public static bool FormFieldGenderEnabled
        {
            ...
            set { SettingManager.SetParam("FormField.GenderEnabled", value.ToString()); }
        }
        ...
        public static bool FormFieldDateOfBirthEnabled
        {
            ...
            set { SettingManager.SetParam("FormField.DateOfBirthEnabled", value.ToString()); }
        }
        ...
        public static bool FormFieldCompanyEnabled
        {
            ...
            set { SettingManager.SetParam("FormField.CompanyEnabled", value.ToString()); }
        }
        ...
        public static bool FormFieldCompanyRequired
        {
            ...
            set { SettingManager.SetParam("FormField.CompanyRequired", value.ToString()); }
        }
        ...
        public static bool FormFieldStreetAddressEnabled
        {
            ...
            set { SettingManager.SetParam("FormField.StreetAddressEnabled", value.ToString()); }
        }
        ...
        public static bool FormFieldStreetAddressRequired
        {
            ...
            set { SettingManager.SetParam("FormField.StreetAddressRequired", value.ToString()); }
        }
        ...
        public static bool FormFieldStreetAddress2Enabled
        {
            ...
            set { SettingManager.SetParam("FormField.StreetAddress2Enabled", value.ToString()); }
        }
        ...
        public static bool FormFieldStreetAddress2Required
        {
            ...
            set { SettingManager.SetParam("FormField.StreetAddress2Required", value.ToString()); }
        }
        ...
        public static bool FormFieldPostCodeEnabled
        {
            ...
            set { SettingManager.SetParam("FormField.PostCodeEnabled", value.ToString()); }
        }
        ...
        public static bool FormFieldPostCodeRequired
        {
            ...
            set { SettingManager.SetParam("FormField.PostCodeRequired", value.ToString()); }
        }
        ...
        public static bool FormFieldCityEnabled
        {
            ...
            set { SettingManager.SetParam("FormField.CityEnabled", value.ToString()); }
        }
        ...
        public static bool FormFieldCityRequired
        {
            ...
            set { SettingManager.SetParam("FormField.CityRequired", value.ToString()); }
        }
        ...
        public static bool FormFieldCountryEnabled
        {
            ...
            set { SettingManager.SetParam("FormField.CountryEnabled", value.ToString()); }
        }
        ...
        public static bool FormFieldPhoneEnabled
        {
            ...
            set { SettingManager.SetParam("FormField.PhoneEnabled", value.ToString()); }
        }
        ...
        public static bool FormFieldPhoneRequired
        {
            ...
            set { SettingManager.SetParam("FormField.PhoneRequired", value.ToString()); }
        }
        ...
        public static bool FormFieldFaxEnabled
        {
            ...
            set { SettingManager.SetParam("FormField.FaxEnabled", value.ToString()); }
        }
        ...
        public static bool FormFieldFaxRequired
        {
            ...
            set { SettingManager.SetParam("FormField.FaxRequired", value.ToString()); }
        }
        ...
        public static bool FormFieldNewsletterEnabled
        {
            ...
            set { SettingManager.SetParam("FormField.NewsletterEnabled", value.ToString()); }
        }
